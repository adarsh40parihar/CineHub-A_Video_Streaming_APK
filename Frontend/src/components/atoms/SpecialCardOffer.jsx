...
const SpecialOfferCard = (props) => {
    const { title, features, price, originalPrice, discountLabel, duration, isActive, onClick } = props;
    return (
        <div
        ...
        >
            ...
            <div className="flex flex-col items-center text-center h-full justify-between">
                ...
                <div className="flex justify-end w-full mt-1">
                    <div className="text-sm line-through text-gray-400 mr-2">
                        ₹{originalPrice}
                    </div>
                    <div className="text-base text-yellow-300">{discountLabel}</div>
                </div>
            </div>
        </div>
    );
